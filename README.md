...
I enjoy learning new technologies, improving my problem-solving skills, and collaborating on projects that challenge me to grow as a developer.
...
I enjoy turning ideas into complete software solutions and working on projects that combine backend, frontend, mobile development, and databases.

- 🚀 RESTful APIs with **ASP.NET Core**
- 🌐 Responsive Web Applications with **React**
- 📱 Cross-platform Mobile Apps with **React Native**
- 🗄 Relational Database Design with **PostgreSQL** and **SQL Server**
